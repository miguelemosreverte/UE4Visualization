...
class HTML_Injector:
    ...
    def __init__(self):
        ...
        self.default_clustering_option = 10
    ...
    def setDefaultClusteringOption(self, default_clustering_option = 10):
    ...
    def prepare_default_clustering_option(self):
        clustering_option = (
        'var currentValue = "vis_index' + str(self.default_clustering_option) + '";\n'
        +'  var currentValueNumerical = ' + str(self.default_clustering_option) + ';\n')
        return clustering_option
    ...
    def injectIntoHTML(self):
        ...
        footer = self.add_at(" <!--currentValue start here. ",self.prepare_default_clustering_option(), footer)
        # inject data
        contentHTML = ""
