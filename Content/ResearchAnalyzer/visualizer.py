...
class Visualizer():
    ...
    def __init__(self, specific_index=-5, default_clustering_option = 10, ammount_of_neighboors_to_show = 0, recalculate = True):
        self.specific_index = specific_index
        self.default_clustering_option = default_clustering_option
        self.ammount_of_neighboors_to_show = ammount_of_neighboors_to_show
        self.show_all = True
        ...
        self.injector.setDefaultClusteringOption(self.default_clustering_option)
    ...
    def check_if_valid_and_set_option(self, index = 0):
        start = self.specific_index - self.ammount_of_neighboors_to_show
        end = self.specific_index + self.ammount_of_neighboors_to_show
...
if __name__ == "__main__":
    ...
    os.chdir(dname)
    if len(sys.argv) == 4:
        vis = Visualizer(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[3]))
    else:
        vis = Visualizer()
